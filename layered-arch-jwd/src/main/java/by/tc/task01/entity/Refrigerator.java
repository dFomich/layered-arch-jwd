...
public class Refrigerator extends Appliance {
	...
	public boolean equals(Object o) {
		...
		return Double.compare(that.powerConsumption, powerConsumption) == 0 && Double.compare(that.weight, weight) == 0
	...
	@Override
	public int hashCode() {
		return (int) (29 * powerConsumption + 23 * weight + 19 * freezerCapacity + 13 * overallCapacity + 7 * height
				+ 5 * width);
	}
	...
	public String toString() {
		return getClass().getSimpleName() + "{" + ", powerConsumption=" + powerConsumption + ", weight=" + weight
				+ ", freezerCapacity=" + freezerCapacity + ", overallCapacity=" + overallCapacity + ", height=" + height
				+ ", width=" + width + '}';
	}
